...
class TestIncrementalWithoutUniqueKey(TestIncrementalUniqueKeyBase):
    ...
    def test__redshift_no_unique_keys(self):
...
class TestIncrementalStrUniqueKey(TestIncrementalUniqueKeyBase):
    @use_profile('redshift')
    def test__redshift_empty_str_unique_key(self):
    ...
    @use_profile('redshift')
    def test__redshift_one_unique_key(self):
    ...
    @use_profile('redshift')
    def test__redshift_bad_unique_key(self):
...
class TestIncrementalListUniqueKey(TestIncrementalUniqueKeyBase):
    @use_profile('redshift')
    def test__redshift_empty_unique_key_list(self):
        '''with no unique keys, seed and model should match'''
        seed='seed'
        seed_rows=8
    ...
    @use_profile('redshift')
    def test__redshift_unary_unique_key_list(self):
        '''with one unique key, model will overwrite existing row'''
        seed='seed'
        seed_rows=7
    ...
    @use_profile('redshift')
    def test__redshift_duplicated_unary_unique_key_list(self):
    ...
    @use_profile('redshift')
    def test__redshift_trinary_unique_key_list(self):
    ...
    @use_profile('redshift')
    def test__redshift_trinary_unique_key_list_no_update(self):
    ...
    @use_profile('redshift')
    def test__redshift_bad_unique_key_list(self):
        '''expect compilation error from unique key not being a column'''

...
core_req_sed_pattern="s/#egg=dbt-core/@${git_branch}#egg=dbt-core/g"
postgres_req_sed_pattern="s/#egg=dbt-postgres/@${git_branch}#egg=dbt-postgres/g"
tests_req_sed_pattern="s/#egg=dbt-tests/@${git_branch}#egg=dbt-tests/g"
